...
| **UI 美化** | `/ui` | 主题 + 状态栏 + 动效 + 全屏 | 一键美化整个 CLI |
| **中文语言包** | `/cn` | UI + 回复 + 动画全中文 | 一键中文化 |
| **思维链回显** | `/think` | 扩展思考 + 摘要 + 详细模式 | Opus 4.7 思考链 |
...
/ui
```
> 一键美化整个 Claude Code CLI：主题、彩色状态栏、思考摘要、回合耗时、加载动画、全屏模式、终端字体推荐等。
